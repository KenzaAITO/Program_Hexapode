...
if MY_DXL == 'X_SERIES' or MY_DXL == 'MX_SERIES':
    ...
    DXL_MINIMUM_POSITION_VALUE  = 2200         # Refer to the Minimum Position Limit of product eManual
    DXL_MAXIMUM_POSITION_VALUE  = 1210      # Refer to the Maximum Position Limit of product eManual
    BAUDRATE                    = 1000000
